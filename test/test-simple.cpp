...
TEST_F(TCPSimpleTest, negativeCommunicationTest_not_connected) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(TCPSimpleTest, negativeCommunicationTest_try_to_connecting_invalid_url) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(TCPSimpleTest, negativeCommunicationTest_rcvStopBytes) {
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;

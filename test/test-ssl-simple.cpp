...
TEST_F(SSLSimpleTest, communicationTest_startBytes) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_startBytes_ov1) {
    char data[5];
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_startBytes_ov2) {
    char data[5];
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_startBytes_ov3) {
...
TEST_F(SSLSimpleTest, communicationTest_rcvUntillStopBytes) {
...
TEST_F(SSLSimpleTest, communicationTest_rcvUntillStopBytes_ov1) {
    char data[5];
    unsigned char buffer[512];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_rcvUntillStopBytes_ov2) {
    char data[5];
    unsigned char buffer[512];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_rcvUntillStopBytes_ov3) {
...
TEST_F(SSLSimpleTest, communicationTest_rcvStopBytes) {
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(SSLSimpleTest, communicationTest_rcvStopBytes_ov1) {
    char data[5];
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_rcvStopBytes_ov2) {
    char data[5];
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
...
TEST_F(SSLSimpleTest, communicationTest_rcvStopBytes_ov3) {
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(SSLSimpleTest, communicationTest_rcvNBytes) {
    unsigned char buffer[512];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(SSLSimpleTest, negativeCommunicationTest_not_connected) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(SSLSimpleTest, negativeCommunicationTest_try_to_connecting_invalid_url) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
...
TEST_F(SSLSimpleTest, negativeCommunicationTest_no_input_bytes_available) {
    unsigned char buffer[8];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
    ...
    gettimeofday(&tvEnd, NULL);
    diffTime = (tvEnd.tv_sec - tvStart.tv_sec) * 1000 + (tvEnd.tv_usec - tvStart.tv_usec) / 1000;
    ASSERT_EQ(diffTime >= 245 && diffTime <= 325, true);
    ASSERT_EQ(client.getDataSize(), 0);
    ASSERT_EQ(client.getBuffer(buffer, sizeof(buffer)), 0);
    ASSERT_EQ(client.getBuffer(tmp), 0);
    tmp.clear();
...
TEST_F(SSLSimpleTest, negativeCommunicationTest_rcvStopBytes) {
    unsigned char buffer[16];
    pthread_t thread;
    std::vector <unsigned char> tmp;
    struct timeval tvStart, tvEnd;
    ...
    ASSERT_EQ(client.init(), 0);
    ASSERT_EQ(client.sendData((const unsigned char *) TEST_STR_4, 16), 0);
    ASSERT_EQ(client.receiveStopBytes((const unsigned char *) TEST_STR_4 + 1, 4), 3);
    gettimeofday(&tvEnd, NULL);
    diffTime = (tvEnd.tv_sec - tvStart.tv_sec) * 1000 + (tvEnd.tv_usec - tvStart.tv_usec) / 1000;
    ASSERT_EQ(diffTime >= 0 && diffTime <= 50, true);
    ASSERT_EQ(client.getDataSize(), 16);
    ASSERT_EQ(client.getBuffer(buffer, sizeof(buffer)), 16);
    ASSERT_NE(memcmp(buffer, (const unsigned char *) TEST_STR_4 + 1, 4), 0);
    ASSERT_EQ(client.getBuffer(tmp), 16);
    ASSERT_EQ(tmp.size(), 16);
    ASSERT_NE(memcmp(tmp.data(), (const unsigned char *) TEST_STR_4 + 1, 4), 0);
    tmp.clear();
    tmp = client.getBufferAsVector();
    ASSERT_EQ(tmp.size(), 16);
    ASSERT_EQ(memcmp(tmp.data(), (const unsigned char *) TEST_STR_4, 4), 0);

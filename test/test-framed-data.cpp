...
TEST_F(TCPFramedDataTest, ReadNegativeTest_2) {
    unsigned char buffer[16];
    struct timeval tvStart, tvEnd;
    int diffTime = 0;
    std::vector <unsigned char> tmp;
